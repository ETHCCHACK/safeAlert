...
export class approvedToken extends ethereum.Event {
  get params(): approvedToken__Params {
    return new approvedToken__Params(this);
  }
}

export class approvedToken__Params {
  _event: approvedToken;

  constructor(event: approvedToken) {
    this._event = event;
  }
